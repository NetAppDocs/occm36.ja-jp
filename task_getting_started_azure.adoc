...
[role="lead"]
Cloud Volumes ONTAP は、 NetApp Cloud Central から Azure で使用を開始できます。Cloud Manager の導入手順については、を参照してください link:task_installing_azure_gov.html["Azure US Government リージョン"] およびインチ 。
